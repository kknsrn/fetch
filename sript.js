...
document.body.innerHTML=` 
                        <div class="user-form">
                        <input class="add-user-name" placeholder="add your name"/>
<input class="add-user-avatar" placeholder="place your image url"/>
...
usercontainer.innerHTML+=`<div class="user-contaier">
       ...
       <input value=${user.avatar} class="edit-${user.id}-useravatar" placeholder="Enter your image url"/>
